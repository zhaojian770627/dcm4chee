...
public class UpdateAttributesService extends ServiceMBeanSupport {
    ...
    private String coerceStylesheet;
    private boolean coerceInstanceLevel;
    ...
    public String getCoerceStylesheet() {
        return coerceStylesheet == null ? NONE : coerceStylesheet;
    }

    public void setCoerceStylesheet(String xsl) {
        coerceStylesheet = NONE.equals(xsl) ? null : xsl;
    }

    public boolean isCoerceInstanceLevel() {
        return coerceInstanceLevel;
    }

    public void setCoerceInstanceLevel(boolean coerceInstanceLevel) {
        this.coerceInstanceLevel = coerceInstanceLevel;
    }
    ...
    protected int updateFiles(FileInfo[][] fileInfos, UpdateAttributes updateAttributes) throws Exception {
        ...
        for (int i = 0; i < fileInfos.length; i++) {
            try {
                ...
                if (inst != null) {
                    ...
                    if (coerceInstanceLevel)
                        coerceAttributes(coerceStylesheet, inst);
        ...
        if (ds != null) {
            ...
            try {
                if (!coerceInstanceLevel)
                    coerceAttributes(coerceStylesheet, ds);
    ...
    public void coerceAttributes(String xsl, Dataset in) {
        if (xsl != null) {
            ...
            if (coerce != null) {
                log.info("Coerce attributes with "+xsl);
                CoercionUtils.coerceAttributes(in, coerce);
            }
        }
    }
}
